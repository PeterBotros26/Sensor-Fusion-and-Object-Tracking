...
def visualize_img_map(name,img_map):
        img_map = (img_map * 255).astype(np.uint8)
        cv2.imshow(name, img_map)
...
def bev_from_pcl(lidar_pcl, configs):
    ...
    #visualize_img_map('img_intensity',intensity_map)
    ...
    #visualize_img_map('height_map',height_map)
    ...
    DHI_map = np.zeros((configs.bev_height, configs.bev_width, 3))
    DHI_map[:, :, 0] = density_map[:configs.bev_height, :configs.bev_width]  # r_map
    DHI_map[:, :, 1] = height_map[:configs.bev_height, :configs.bev_width]  # g_map
    DHI_map[:, :, 2] = intensity_map[:configs.bev_height, :configs.bev_width]  # b_map
    
    
    #visualize_img_map('DHI_map',DHI_map)
